                ...
                if q.status == Status.PENDING_QUEUE:
                    ...
                    try:
                        ...
                        if 'Success' not in out:
                            ...
                            run_adb(['shell', 'screencap', '-p', '/data/local/tmp/screenshot.png'])
                            run_adb(['pull', '/data/local/tmp/screenshot.png', 'screenshots/' + q.id + '.png'])
                            run_adb(['shell', 'rm', '-f', '/data/local/tmp/screenshot.png'])
